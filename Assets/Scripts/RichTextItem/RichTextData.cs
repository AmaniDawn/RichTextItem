...
namespace GameLogic
{
    ...
    internal class EmojiAnimationInstance
    {
        ...
        public static EmojiAnimationInstance Create(Image targetImage, EmojiAnimationData animData)
        {
        ...
        public bool TryGetNextFrame(out Image image, out string spriteName)
        {
            image = null;
            spriteName = null;
