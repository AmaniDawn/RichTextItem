...
namespace GameLogic
{
    ...
    public class RichTextItem : MonoBehaviour
    {
        ...
        private bool m_enableAsyncRendering = true;
        ...
        // 对象池
        private readonly List<Text> m_textPool = new List<Text>();
        private readonly List<Image> m_imagePool = new List<Image>();
        private readonly List<Text> m_activeTexts = new List<Text>();
        private readonly List<Image> m_activeImages = new List<Image>();
        private readonly List<Image> m_underlinePool = new List<Image>();
        private readonly List<Image> m_activeUnderlines = new List<Image>();
        ...
        private readonly List<Text> m_linkTexts = new List<Text>();
            ...
            ref RichTextRow currentRow)
        {
            ...
            var button = label.gameObject.GetComponent<Button>();
        ...
        private void CreateUnderline(RectTransform parent, float width, Color color)
        {
            ...
            else
            {
                ...
                underlineImage = underlineGo.AddComponent<Image>();
        ...
        private void SetupTextCommon(Text text)
        {
            text.font = m_font;
        ...
        private void SetupImageCommon(Image image, bool raycastEnabled)
        {
        ...
        private void ApplyTextEffects(Text text)
        {
            // 阴影 - 使用 Unity 的 Shadow 组件
            ...
            if (m_currentParams.EnableShadow)
            {
                ...
                shadow.enabled = true;
                shadow.effectDistance = m_currentParams.ShadowEffectDistance;
                shadow.effectColor = m_currentParams.ShadowTopLeftColor;
            }
            else if (shadow != null)
            {
            ...
            if (m_currentParams.EnableOutline)
            {
                ...
                outline.effectColor = m_currentParams.OutlineColor;
                outline.effectDistance = new Vector2(m_currentParams.OutlineWidth, m_currentParams.OutlineWidth);
            }
